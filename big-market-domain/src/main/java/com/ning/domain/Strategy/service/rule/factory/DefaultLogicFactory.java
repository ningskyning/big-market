package com.ning.domain.Strategy.service.rule.factory;
...
public class DefaultLogicFactory {
    ...
    public enum LogicModel {
        ...
        RULE_LOCK("rule_lock","【抽奖中规则】抽奖次数过滤，小于次数要求则缩小卡池","center"),
        RULE_LUCKY_AWARD("rule_lucky_award","【抽奖后规则】幸运奖励兜底","after"),
